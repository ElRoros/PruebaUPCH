...
const UserModal = ({ showModal, handleClose, editingUser, updateUser }) => {
  const [user, setUser] = useState({ picture: { medium: '' }, name: { first: '', last: '' }, gender: '', location: { street: { name: '', number: '' }, nat: '' }, cell: '', email: ''});
        ...
        <div className="modal-content">
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              className="form-control"
              value={user.location.street ? user.location.street.number : ''}
